...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\assina-facil\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\assina-facil\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'dashboard','notifications.index','profile.edit',
'profile.update','profile.destroy','resellers.index','resellers.show','resellers.store',
'resellers.update','resellers.destroy','admin.dashboard','clients.index','clients.show',
'clients.store','clients.update','clients.destroy','services.index','services.create',
'services.show','services.edit','services.store','services.update','services.destroy',
'plans.index','plans.create','plans.show','plans.edit','plans.store',
'plans.update','plans.destroy','payments.index','payments.show','client.dashboard',
'services.list','services.view','services.contract','pending.index','pending.show',
'payments.history','payments.show','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.clients.index','admin.clients.show','admin.dashboard','admin.payments.index','admin.payments.show',
'admin.resellers.index','admin.resellers.show','admin.services.create','admin.services.edit','admin.services.index',
'admin.services.plans.create','admin.services.plans.edit','admin.services.plans.index','admin.services.show','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.verify-email',
'client.dashboard','client.history.index','client.history.show','client.pending.index','client.pending.show',
'client.service.index','client.service.show','components.alert','components.application-logo','components.aside-link',
'components.auth-session-status','components.bread-crumb','components.danger-button','components.dropdown','components.dropdown-link',
'components.input-error','components.input-label','components.modal','components.nav-link','components.primary-button',
'components.primary-input','components.primary-select','components.responsive-nav-link','components.secondary-button','components.service-card',
'components.steps','components.table','components.text-input','dashboard','layouts.app',
'layouts.aside','layouts.guest','layouts.navbar','layouts.navigation','notification',
'pagination::custom','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'vendor.pagination.custom','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'validation.attributes.winner','validation.attributes.work','validation.attributes.year','pt.0','actions.accept',
...
'SESSION_DOMAIN','SESSION_SECURE_COOKIE','SESSION_SAME_SITE','BROADCAST_CONNECTION','FILESYSTEM_DISK',
...
'VITE_APP_NAME','ADMIN_ROLE_ID','DEALER_ROLE_ID','CLIENT_ROLE_ID',);
